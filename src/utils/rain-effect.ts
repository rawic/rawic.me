...
export const makeItRain = () => {
    if (!doc.querySelector('.rain')) {
        return;
    }
    //clear out everything
    doc.querySelector('.rain').innerHTML = '';
    ...
    doc.querySelector('.rain.front-row').innerHTML += drops;
    doc.querySelector('.rain.back-row').innerHTML += backDrops;
};
