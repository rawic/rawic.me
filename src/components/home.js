      ...
      <article className={homeStyles.articleBox}>
        <header className={`${homeStyles.articleHeader} gradient-text`}>
          <h2 className={`${homeStyles.title}`}>
            ...
            Jestem programistą z <span className="s-white">Wars</span>
            <span className="s-red">zawy</span>,
        ...
        <section>
          ...
          <h3>O mnie</h3>
          <p>
            Wdrażam rozwiązania warstwy Front-End, ale ambitnie dążę do
            wszechstronności w&nbsp;branży IT. Mam&nbsp;udokumentowane ponad
            7-letnie doświadczenie w&nbsp;budowaniu aplikacji internetowych.
            Potrafię projektować UI, a&nbsp;także znam podstawy UX.
          ...
          <p>
            Potrafię pracować indywidualnie jak i&nbsp;w&nbsp;ramach zespołu.
            Zawsze chętnie pomagam innym. Lubię się uczyć, dzielić wiedzą
            i&nbsp;uważnie słucham. Niezależnie od &nbsp;wyzwania, dążę
            do&nbsp;realizacji idealnego produktu, o&nbsp;odpowiedniej
            wydajności, użyteczności i&nbsp;dostępności. Mądrze pracuję,
            aby&nbsp;to&nbsp;osiągnąć.
